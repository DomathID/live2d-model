...
!(function (t, e) {
    ...
    var s,
        ...
        v = function (t, e) {
            ...
            var i = getComputedStyle(t),
                ...
                D = J + b + I + E,
                q = k + S + x + K,
                Z = r({ devicePixelContentBoxSize: m(Math.round(J * devicePixelRatio), Math.round(k * devicePixelRatio), c), borderBoxSize: m(D, q, c), contentBoxSize: m(J, k, c), contentRect: new o(Y, F, J, k) });
            return u.set(t, Z), Z;
        },
        F = function (e, i, s) {
            var r = v(e, s),
        ...
        L = function () {
            ...
            return (
                ...
                }) && ("function" == typeof ErrorEvent ? (t = new ErrorEvent("error", { message: i })) : ((t = document.createEvent("Event")).initEvent("error", !1, !1), (t.message = i)), window.dispatchEvent(t)),
                s > 0
            );
        },
        A = [],
        ...
        J = (function () {
            function e(e, i) {
                (this.target = e), (this.observedBox = i || t.CONTENT_BOX), (this.lastReportedSize = { inlineSize: 0, blockSize: 0 });
            }
            return (
    ...
    var N = {
        chisato: {
            image:
                `https://i.ibb.co.com/RY1jYzQ/20240624-014002.png`,
    ...
    const z = { size: 200, autoFit: !1, character: "chisato", controls: !0, rod: !0, draggable: !0, stroke: { color: "#b4b4b4", width: 10 }, threshold: 0.1, rotate: 0, title: !1 };
    let T = null;
    function Q() {
        T ||
            ((T = {}),
            ...
            (this._lastRunUnix = Date.now()),
                ...
                (this._run = () => {
                    ...
                    l < 16 && (c = (a / this._frameUnix) * l),
                        ...
                        (this._state.t = r * o),
                        (this._state.y = s),
                        Math.max(Math.abs(this._state.w), Math.abs(this._state.r), Math.abs(this._state.t), Math.abs(this._state.y)) < e ? (this._running = !1) : (this._draw(), requestAnimationFrame(this._run));
                }),
                (this._move = (t, e) => {
                ...
                (this._magicForce = () => {
                    if (Math.random() < 0.1) {
                        ...
                        this.setCharacter(e);
                    } else (this._state.t = this._state.t + 150 * (Math.random() - 0.5)), (this._state.w = this._state.w + 200 * (Math.random() - 0.5));
                ...
                (this.setState = (t) => (this._state || (this._state = {}), (this._state = M(this._state, U(t))), this)),
                (this.setCharacter = (t) => {
                    const e = T[t];
                ...
                (this.mount = (t) => {
                    ...
                    this._options.draggable && (this._domImage.addEventListener("mousedown", this._onMouseDown), this._domImage.addEventListener("touchstart", this._onTouchStart)),
